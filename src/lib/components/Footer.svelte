    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="grid md:grid-cols-4 gap-12 border-t border-white/10 pt-16">
            ...
            <div class="md:col-span-3 space-y-6">
                {#each ['How is Playframe different from other generative AI tools?', 'What types of content can I create on Playframe?', 'How does Playframe help me beyond content creation?', 'What if I already use an SEO agency?', 'How does pricing work?'] as q}
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mt-24 text-sm text-gray-400">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="hover:text-white">Playframe Research</a></li>
                    <li><a href="#" class="hover:text-white">SEO AI Leader Playbook</a></li>
                    <li><a href="#" class="hover:text-white">SEO Analysis</a></li>
                    <li><a href="#" class="hover:text-white">Playframe vs Writer</a></li>
                    <li><a href="#" class="hover:text-white">Playframe vs Jasper</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="hover:text-white">Playframe Job Board</a></li>
        ...
        <div class="mt-32 text-center relative">
             <h1 class="text-[12rem] md:text-[16rem] font-bold tracking-tighter leading-none text-white select-none">Playframe</h1>
